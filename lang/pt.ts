export const TRANSLATION_PT = {
  landing: {
    ...
    title: "Interação real no mundo virtual",
    register_for_early_access: "Cadastre-se para acesso antecipado",
    contact_us: "Entre em contato conosco para ter acesso",
    join_nexus: "Junte-se ao Nexus",
    ...
    focus_on_human_interaction: "Estamos focados na interação humana",
    focus_on_human_interaction_message: `As melhores atividades para equipes remotas, eventos virtuais e educação online`,
    ...
    audience: {
      ...
      options: {
        personal: {
          title: "Indivíduos",
          message: "Divirta-se com seus amigos próximos.",
        },
        eventsCreator: {
          title: "Criador de eventos",
          message: "O Nexus é ideal para que os participantes do seu evento se conheçam.",
        },
        office: {
          title: "Equipes",
          message: "As melhores atividades de team building.",
        },
        communities: {
          title: "Institutos educacionais",
          message:
            "Quem disse que você não pode ter amigos em seus cursos virtuais? Divirta-se com seus colegas de classe como na vida real.",
        },
      },
    },
    statistics: {
    ...
    features: {
      when_to_use: {
        ...
        options: {
          ...
          option_6: {
            title: "Cerimônias de premiação de funcionários/alunos",
            message:
  ...
  bill: {
    pay_pending_bills: "Pagar contas pendentes",
    you_have_no_pending_bills: `Você não tem contas pendentes`,
  },
  common: {
  ...
  room: {
    ...
    ask_to_your_manager: "Você não tem planos ativos. Peça ao administrador para atualizar seu plano.",
  ...
  account: {
    ...
    bills: "Notas",
    pay_as_you_go_plan: "Plano de pagamento conforme o uso",
  },
  languages: {
    en: "Inglês",
    es: "Espanhol",
