export const TRANSLATION_ES = {
  landing: {
    ...
    title: "Interacción real en el mundo virtual",
    register_for_early_access: "Regístrese para acceso anticipado",
    contact_us: "Contáctenos para acceder",
    join_nexus: "Unirse a Nexus",
    ...
    focus_on_human_interaction: "Estamos enfocados en la interacción humana",
    focus_on_human_interaction_message: `Las mejores actividades para equipos remotos, eventos virtuales y educación en linea`,
    future: "El futuro es remoto",
    audience: {
      title: "¿Es Nexus adecuado para mi equipo?",
      options: {
        personal: {
          title: "Particulares",
          message: "Diviértete con tus amigos cercanos.",
        },
        eventsCreator: {
          title: "Creadores de eventos",
          message: "Nexus es ideal para que los asistentes a tu evento se conozcan.",
        },
        office: {
          title: "Equipos",
          message: "Las mejores actividades de team building.",
        },
        communities: {
          title: "Institutos Educativos",
          message:
            "¿Quién dijo que no puedes tener amigos en tus cursos virtuales? Diviértete con tus compañeros de clase como en la vida real.",
        },
      },
    },
    statistics: {
    ...
    features: {
      when_to_use: {
        ...
        options: {
          ...
          option_6: {
            title: "Ceremonias de premiación para Empleado/Estudiantes",
            message:
  ...
  bill: {
    pay_pending_bills: "Pagar facturas pendientes",
    you_have_no_pending_bills: `No tienes facturas pendientes`,
  },
  common: {
    ...
    winners: "Ganadores",
    player: "Jugador",
    invite_your_teammates_to_the_party: "Invita a tus compañeros de trabajo a la fiesta",
    share_link: "Compartir link",
    link_copied_to_the_clipboard:
      "Link copiado al portapapeles. Compartelo con tus compañeros de trabajo.",
  ...
  room: {
    ...
    ask_to_your_manager: "No tienes ningún plan activo. Pida a su administrador que actualice su plan.",
  ...
  hypotethically: {
    storyTimePrefix: "Cuentanos: ¿Que harias si",
  ...
  account: {
    ...
    bills: "Facturas",
    pay_as_you_go_plan: "Plan de pago por uso",
  },
  languages: {
    en: "Inglés",
    es: "Español",
